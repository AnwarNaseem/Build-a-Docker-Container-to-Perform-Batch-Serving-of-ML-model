...
def inference():
    ...
    # Run Neural Networks multi-layer perceptron(MLP) model
    ...
    # Run Random Forest Classifer Model
    rfc = load(MODEL_PATH_RFC)
    print('RFC score and classification:')
    prediction_rfc = rfc.predict(X_test)
    report_rfc = classification_report(y_test,prediction_rfc)

    print(rfc.score(X_test,y_test))
    print("RFC Predictions:", prediction_rfc)
    print("RFC classification report:", report_rfc)
